...
public:
	...
	template<typename UEType = UObject>
	static UEType* FindObject_NonStatic(const std::string& FullName, EClassCastFlags RequiredType = EClassCastFlags::None)
	{
		for (int i = 0; i < GObjects->Num(); ++i)
		{
			UObject* Object = GObjects->GetByIndex(i);
			...
			if (Object->HasTypeFlag(RequiredType) && Object->GetFullName() == FullName && !Object->IsDefaultObject())
			{
				return static_cast<UEType*>(Object);
			}
		}
...
{
public:
	uint8                                        Pad_1[0x48];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_3[0x10];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	...
	uint8                                        Pad_4[0x54];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6[0x78];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	void* ClassConstructor; //0x00B0
	class UObject* ClassVTableHelperCtorCaller; //0x00B8
	void* ClassAddReferencedObjects; //0x00C0
	//uint32_t bCooked; //0x00C8
	//uint32_t ClassUnique; //0x00CC
	//EClassFlags ClassFlags; //0x00D0
	//EClassCastFlags CastFlags; //0x00D4
	//class UClass* ClassWithin; //0x00D8
	//class UObject* ClassGeneratedBy; //0x00E0
	//uint32_t ClassConfigName; //0x00E8
	//class TArray<FRepRecord> ClassReps; //0x00EC
	//class TArray<UField*> NetFields; //0x00FC
	//uint32_t FirstOwnedClassRep; //0x010C
	//uint64_t CallAddReferencedObjects; //0x0110
	//class UObject* DefaultObject; //0x0118
	//char N000001D5[16]; //0x0120
	//void* SparseClassData; //0x0130
	//char pad_0138[56]; //0x0138
	//void* SparseClassDataStruct; //0x0170
	//char pad_0178[192]; //0x0178

	uint8                                        Pad_7[0x8];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	enum class EClassCastFlags                   CastFlags;                                         // (0xD0[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_7_1[0x24];
	class TArray<UField*> NetFields;                                                                //0x00FC[0x10]
	uint8                                        Pad_8[0x8];                                       // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
...
{
public:
	using FNativeFuncPtr = void (*)(class UObject* Context, struct FFRame& TheStack, void* Result);                                                  // (0x00[0x00]) NOT AUTO-GENERATED PROPERTY
...
{
public:
	uint8                                        Pad_10[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_11[0xC8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_12[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_13[0xA0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_15[0x40];                                      // Fixing Size Of Struct [ Dumper-7 ]
