...
class UClass* ABP_Terrace_Roof_B1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Terrace_Roof_B1_C");

	return Clss;
}


// BP_Terrace_Roof_B1_C BP_Terrace_Roof_B1.Default__BP_Terrace_Roof_B1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Terrace_Roof_B1_C* ABP_Terrace_Roof_B1_C::GetDefaultObj()
{
	static class ABP_Terrace_Roof_B1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Terrace_Roof_B1_C*>(ABP_Terrace_Roof_B1_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Terrace_Roof_B1.BP_Terrace_Roof_B1_C.UserConstructionScript
