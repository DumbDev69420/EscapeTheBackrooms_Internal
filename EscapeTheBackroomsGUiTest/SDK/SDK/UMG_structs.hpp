...
{
public:
	uint8                                        Pad_1A2D[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1A33[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1A37[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
