...
public:
	...
	uint8                                        Pad_FFA[0x9C];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_107C[0x390];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_107E[0x148];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1080[0x1E4];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_108A[0xA4];                                    // Fixing Size Of Struct [ Dumper-7 ]
