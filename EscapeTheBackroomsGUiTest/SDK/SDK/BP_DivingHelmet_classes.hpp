...
class ABP_DivingHelmet_C : public AActor
{
public:
	...
	void ExecuteUbergraph_BP_DivingHelmet(int32 EntryPoint, class AActor* K2Node_CustomEvent_Player, class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue);
};
