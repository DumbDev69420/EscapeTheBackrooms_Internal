...
class UClass* ABP_Terrace_Base_C_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Terrace_Base_C_C");

	return Clss;
}


// BP_Terrace_Base_C_C BP_Terrace_Base_C.Default__BP_Terrace_Base_C_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Terrace_Base_C_C* ABP_Terrace_Base_C_C::GetDefaultObj()
{
	static class ABP_Terrace_Base_C_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Terrace_Base_C_C*>(ABP_Terrace_Base_C_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Terrace_Base_C.BP_Terrace_Base_C_C.UserConstructionScript
