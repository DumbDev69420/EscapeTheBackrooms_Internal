...
class UW_VOIP_Speaker_C : public UUserWidget
{
public:
	...
	void Construct();
	void ExecuteUbergraph_W_VOIP_Speaker(int32 EntryPoint, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue);
};
