...
public:
	...
	uint8                                        Pad_9FD[0x44];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A00[0x2A8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_A01[0x60];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A15[0x70];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_A16[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
