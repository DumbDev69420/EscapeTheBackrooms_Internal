...
class UWB_Sensitivity_Theme2_C : public UUserWidget
{
public:
	...
	FMulticastInlineDelegateProperty_            OnMouseCaptureEnd;                                 // 0x288(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

	static class UClass* StaticClass();
	static class UWB_Sensitivity_Theme2_C* GetDefaultObj();

	void Set_SliderValue(float InValue, class FText CallFunc_Conv_FloatToText_ReturnValue);
	void Construct();
	...
	void ExecuteUbergraph_WB_Sensitivity_Theme2(int32 EntryPoint, float K2Node_ComponentBoundEvent_Value);
