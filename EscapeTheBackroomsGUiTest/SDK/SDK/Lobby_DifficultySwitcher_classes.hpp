...
class ULobby_DifficultySwitcher_C : public UUserWidget
{
public:
	...
	FMulticastInlineDelegateProperty_            OnDifficultySwitched;                              // 0x2B0(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	void ExecuteUbergraph_Lobby_DifficultySwitcher(int32 EntryPoint, bool K2Node_Event_IsDesignTime);
	void OnDifficultySwitched__DelegateSignature(const class FString& SelectedOption);
};
