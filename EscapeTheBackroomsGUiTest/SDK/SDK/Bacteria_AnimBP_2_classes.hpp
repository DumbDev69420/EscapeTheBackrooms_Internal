...
class UBacteria_AnimBP_2_C : public UAnimInstance
{
public:
	uint8                                        Pad_2195[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	void ExecuteUbergraph_Bacteria_AnimBP_2(int32 EntryPoint, class APawn* CallFunc_TryGetPawnOwner_ReturnValue, const struct FVector& CallFunc_GetVelocity_ReturnValue, bool CallFunc_Greater_FloatFloat_ReturnValue, float CallFunc_VSize_ReturnValue, bool CallFunc_LessEqual_FloatFloat_ReturnValue, float K2Node_Event_DeltaTimeX);
};
